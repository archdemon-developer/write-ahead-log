...
public record SegmentFooter(
    int entryCount, long minTimestamp, long maxTimestamp, long completeMarker, long checksum) {
  ...
  public boolean isValid() {
    try {
      long computedChecksum =
          calculateChecksum(entryCount, minTimestamp, maxTimestamp, completeMarker);
  ...
  private static long calculateChecksum(
      int entryCount, long minTimestamp, long maxTimestamp, long completeMarker)
      throws IOException {
