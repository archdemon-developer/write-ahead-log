...
public class SegmentManager {
    ...
    public List<LogEntry> readAllAfterTimestamp(long timestamp)  throws IOException {
        ...
        for(SegmentMetadata segmentMetadata : segmentsAfterTimestamp) {
            byte[] allBytes = FileUtils.readAllBytes(FileUtils.getLogFile(logDir, segmentMetadata.filename()));
    ...
    private void rotateSegment() throws IOException {
        ...
        SegmentMetadata updated = new SegmentMetadata(allSegments.getLast().filename(), currentSegmentMinTimestamp, currentSegmentMaxTimestamp);
    ...
    private String formatTimestamp(long timestampMs) {
        ...
        DateTimeFormatter timestampFormatter = DateTimeFormatter.ofPattern(WalConstants.LOG_FILE_DATE_FORMAT);
