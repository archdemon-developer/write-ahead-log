...
public class FsyncRetryStrategyFactoryTest {
    ...
    void createWithDefaultConfigReturnsExponentialBackoffRetryStrategy() {
        WalConfiguration walConfiguration = new WalConfiguration.Builder()
                .logDir(tempDirectory.toString())
                .build();

        FsyncRetryStrategy createdRetryStrategy = FsyncRetryStrategyFactory.create(walConfiguration, walMetrics);
    ...
    void createMultipleCallsSameConfigReturnsDifferentInstances() {
        ...
        FsyncRetryStrategy firstCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfiguration, walMetrics);
        FsyncRetryStrategy secondCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfiguration, walMetrics);
    ...
    void createMultipleCallsDifferentConfigsReturnDifferentInstances() {
        WalConfiguration walConfigurationWithThreeRetries = new WalConfiguration.Builder()
                .logDir(tempDirectory.toString())
                .maxRetries(3)
                .build();

        WalConfiguration walConfigurationWithTenRetries = new WalConfiguration.Builder()
                .logDir(tempDirectory.toString())
                .maxRetries(10)
                .build();

        FsyncRetryStrategy firstCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfigurationWithThreeRetries, walMetrics);
        FsyncRetryStrategy secondCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfigurationWithTenRetries, walMetrics);
    ...
    void createWithDifferentMetricsInstancesReturnStrategy() {
        ...
        FsyncRetryStrategy firstCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfiguration, firstMetricsInstance);
        FsyncRetryStrategy secondCreatedRetryStrategy = FsyncRetryStrategyFactory.create(walConfiguration, secondMetricsInstance);
