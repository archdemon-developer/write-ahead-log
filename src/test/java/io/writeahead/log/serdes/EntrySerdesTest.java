...
public class EntrySerdesTest {
    ...
    void serializeEntrySanseCrcWithSimplePayloadProducesExpectedByteLength() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, HELLO_SIZE, helloPayloadBytes);
    ...
    void serializeEntrySanseCrcWithEmptyPayloadProducesTimestampAndSizeOnly() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, EMPTY_SIZE, emptyPayloadBytes);
    ...
    void serializeEntrySanseCrcWithLargePayloadProducesExpectedByteLength() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, LARGE_PAYLOAD_SIZE, largePayloadBytes);
    ...
    void serializeEntryWithCrcAddsExactlyEightBytesForCrc() throws IOException {
        ...
        byte[] serializedWithoutCrc = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, HELLO_SIZE, helloPayloadBytes);
        byte[] serializedWithCrc = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, HELLO_SIZE, helloPayloadBytes, REFERENCE_CRC);
    ...
    void deserializeEntryRoundTripPreservesAllFieldsAccurately() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, HELLO_SIZE, helloPayloadBytes, REFERENCE_CRC);
    ...
    void serializeAndDeserializeMultipleTimestampsPreserveIndependence() throws IOException {
        ...
        byte[] firstSerialized = EntrySerdes.serializeEntryWithCrc(firstTimestamp, HELLO_SIZE, helloPayloadBytes, REFERENCE_CRC);
        byte[] secondSerialized = EntrySerdes.serializeEntryWithCrc(secondTimestamp, HELLO_SIZE, helloPayloadBytes, REFERENCE_CRC);
        byte[] thirdSerialized = EntrySerdes.serializeEntryWithCrc(thirdTimestamp, HELLO_SIZE, helloPayloadBytes, REFERENCE_CRC);
    ...
    void serializeAndDeserializeMultipleDifferentPayloadsPreserveIndependence() throws IOException {
        ...
        byte[] alphaSerializedBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, payloadAlpha.length, payloadAlpha, REFERENCE_CRC);
        byte[] betaSerializedBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, payloadBeta.length, payloadBeta, REFERENCE_CRC);
        byte[] gammaSerializedBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, payloadGamma.length, payloadGamma, REFERENCE_CRC);
    ...
    @Test
    void serializeEntrySanseCrcWithDifferentTimestampsProducesDifferentSerialization() throws IOException {
        byte[] helloPayloadBytes = HELLO_PAYLOAD.getBytes();
        long firstTimestamp = 1000L;
        long secondTimestamp = 2000L;

        byte[] firstSerializedBytes = EntrySerdes.serializeEntrySanseCrc(firstTimestamp, HELLO_SIZE, helloPayloadBytes);
        byte[] secondSerializedBytes = EntrySerdes.serializeEntrySanseCrc(secondTimestamp, HELLO_SIZE, helloPayloadBytes);
    ...
    void serializeEntrySanseCrcWithDifferentSizesProducesDifferentSerialization() throws IOException {
        ...
        byte[] serializedWithCorrectSize = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, HELLO_SIZE, helloPayloadBytes);
        byte[] serializedWithIncorrectSize = EntrySerdes.serializeEntrySanseCrc(REFERENCE_TIMESTAMP, HELLO_SIZE + 1, helloPayloadBytes);
    ...
    void deserializeEntryFromEmptyPayloadSerialization() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, EMPTY_SIZE, emptyPayloadBytes, REFERENCE_CRC);
    ...
    void deserializeEntryFromLargePayloadSerialization() throws IOException {
        ...
        byte[] serializedEntryBytes = EntrySerdes.serializeEntryWithCrc(REFERENCE_TIMESTAMP, LARGE_PAYLOAD_SIZE, largePayloadBytes, REFERENCE_CRC);
