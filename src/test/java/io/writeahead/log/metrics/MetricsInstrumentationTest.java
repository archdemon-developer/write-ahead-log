...
public class MetricsInstrumentationTest {
    ...
    void metricsRecordSegmentRotation() throws Exception {
        WalConfiguration configWithSmallSegmentSize = new WalConfiguration.Builder()
        ...
        assertEquals(ENTRIES_TO_FORCE_ROTATION, metrics.getEntriesWritten(), "All entries should be recorded");
